...
var _ model2.IAccountRole = (*AccountRole)(nil)

// AccountRoleSet 注入AccountRoleSet
var AccountRoleSet = wire.NewSet(wire.Struct(new(AccountRole), "*"), wire.Bind(new(model2.IAccountRole), new(*AccountRole)))
...
func (a *AccountRole) Query(ctx context.Context, params schema.AccountRoleQueryParam, opts ...schema.AccountRoleQueryOptions) (*schema.AccountRoleQueryResult, error) {
	...
	db := entity2.GetAccountRoleDB(ctx, a.DB)
