...
var _ model2.IResource = (*Resource)(nil)

// ResourceSet 注入Resource
var ResourceSet = wire.NewSet(wire.Struct(new(Resource), "*"), wire.Bind(new(model2.IResource), new(*Resource)))
...
func (a *Resource) Query(ctx context.Context, params schema.ResourceQueryParam, opts ...schema.ResourceQueryOptions) (*schema.ResourceQueryResult, error) {
	...
	db := entity2.GetResourceDB(ctx, a.DB)
