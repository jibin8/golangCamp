...
func (a *Login) Login(c *gin.Context) {
	...
	if err != nil {
		ginplus2.ResError(c, errors.WithStack(err))
		return
	}
	...
	ginplus2.ResSuccess(c, tokenInfo)
}
...
func (a *Login) Authenticate(c *gin.Context) {
	...
	accountKey := ginplus2.GetAccountKey(c)
	...
	ginplus2.ResSuccess(c, schema.AuthenticateInfo{Grant: grant})
}
